...
GLfloat AStarNode::getValue() const{return priority;}

GLfloat AStarNode::getEstimate() const{return estimate;}
void AStarNode::setEstimate(GLfloat e){estimate = e;}
GLfloat AStarNode::getDistance() const{return distance;}												
void AStarNode::setDistance(GLfloat d){distance = d;}
GLfloat AStarNode::getPriority() const{return priority;}
void AStarNode::setPriority(GLfloat p){priority = p;}	
void AStarNode::findPriority(){priority = estimate + distance;}	
