...
//---- DRAW ----//
void LoadScreen::draw(bool step)
{
...
//---- TOUCH ----//
void LoadScreen::push(GLshort t, const Coord2d<GLshort>& p)
{
	_menu.push(t, p);
}

void LoadScreen::move(GLshort t, const Coord2d<GLshort>& p)
{
	_menu.move(t, p);
}

bool LoadScreen::release(GLshort t, const Coord2d<GLshort>& p)
{
