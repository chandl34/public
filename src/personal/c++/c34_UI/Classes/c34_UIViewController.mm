...
@interface c34_UIViewController ()
...
@implementation c34_UIViewController
...
- (void)awakeFromNib
{
	...
	animating = FALSE;
	animationFrameInterval = 60 / FRAMES_PER_SECOND;
